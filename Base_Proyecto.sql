...
(1, 'Licenciatura en Ingenier�a Civil - Junior'),
(1, 'Licenciatura en Ingenier�a Civil - Middle'),
(1, 'Licenciatura en Ingenier�a Civil - Senior'),
(2, 'Maestr�a en Ciencias de la Computaci�n - Interno'),
(2, 'Maestr�a en Ciencias de la Computaci�n - Residente'),
(2, 'Maestr�a en Ciencias de la Computaci�n - Jefe'),
(3, 'Doctorado en Medicina - Interno'),
(3, 'Doctorado en Medicina - Residente'),
(3, 'Doctorado en Medicina - Jefe'),
(4, 'Licenciatura en Administraci�n de Empresas - Asociado'),
(4, 'Licenciatura en Administraci�n de Empresas - Asociado Senior'),
(4, 'Licenciatura en Administraci�n de Empresas - Socio Gerente'),
(4, 'Licenciatura en Administraci�n de Empresas - Principiante'),
(4, 'Licenciatura en Administraci�n de Empresas - Senior'),
(4, 'Licenciatura en Administraci�n de Empresas - Director');
...
VALUES
    ('Desarrollo de software y servicios inform�ticos'),
    ('Consultor�a empresarial'),
    ('Restaurante o cafeter�a'),
    ('Venta al por menor de productos electr�nicos'),
    ('Servicios de contabilidad y asesor�a fiscal'),
    ('Construcci�n y obras civiles'),
    ('Servicios de dise�o gr�fico y publicidad'),
    ('Consultor�a en recursos humanos'),
    ('Venta al por mayor de alimentos y bebidas'),
    ('Servicios de transporte y log�stica');
...
('Juan', 'Carlos', 'G�mez', 'P�rez', '1990-05-15', 'Ciudad de M�xico', 2, 1, 1, 3, 5, 1, NULL),
('Mar�a', 'Isabel', 'Mart�nez', 'L�pez', '1985-08-22', 'Guadalajara', 1, 2, 2, 2, 8, 1, NULL),
('Pedro', NULL, 'Ram�rez', 'Hern�ndez', '1978-12-10', 'Monterrey', 3, 1, 1, 4, 7, 1, NULL),
('Ana', 'Luisa', 'D�az', 'Guti�rrez', '1995-04-03', 'Puebla', 0, 2, 2, 1, 10, 1, NULL),
('Luis', 'Alberto', 'Hern�ndez', 'Rodr�guez', '1982-06-18', 'Tijuana', 1, 1, 1, 6, 2, 1, NULL),
('Elena', 'Beatriz', 'Torres', 'S�nchez', '1998-09-27', 'Veracruz', 2, 2, 2, 5, 9, 1, NULL),
('Ricardo', NULL, 'Garc�a', 'Mart�nez', '1975-03-14', 'Canc�n', 4, 1, 1, 2, 4, 1, NULL),
('Laura', 'Patricia', 'Flores', 'Ortega', '1991-11-08', 'Oaxaca', 1, 2, 2, 3, 6, 1, NULL),
('Javier', NULL, 'Ru�z', 'Soto', '1987-07-02', 'M�rida', 2, 1, 1, 4, 8, 1, NULL),
('Isabel', 'Cristina', 'Guzm�n', 'Vargas', '1980-02-20', 'Acapulco', 3, 2, 2, 1, 5, 1, NULL);
...
(123456789, 'Llamar despu�s de las 5 PM', 1, 1, 2, 1, 1, 1),
(987654321, 'Enviar un correo electr�nico', 2, 2, 3, 0, 2, 2),
...
(444555666, 'Correo electr�nico secundario', 1, 1, 2, 1, 7, 1),
...
('San Jos�', 21, NULL, 1, 8), -- Provincia
('Heredia', 22, NULL, 1, 8), -- Provincia
('Guanacaste', 23, NULL, 1, 8), -- Provincia
('San Jos�', 24, 21, 2, 8), -- Cant�n (pertenece a San Jos�)
('Heredia', 25, 22, 2, 8), -- Cant�n (pertenece a Heredia)
('Liberia', 26, 23, 2, 8), -- Cant�n (pertenece a Guanacaste)
('San Pedro', 27, 24, 3, 8), -- Ciudad (pertenece a San Jos�)
...
(1, 'Calle Principal 123', 'Apartamento 4B', 12345, 1, 54321, 1, 'Frente al parque', 1, 1, 1), -- Direcci�n 1
(2, 'Avenida Central 456', NULL, 54321, 2, 98765, 0, 'Edificio Azul, Piso 8', 2, 2, 2), -- Direcci�n 2
(3, 'Calle Sur 789', 'Casa 10', 67890, 3, 12345, 1, 'Esquina de la iglesia', 1, 3, 3), -- Direcci�n 3
(1, 'Calle Este 321', 'Apartamento 5A', 54321, 1, 87654, 0, 'Frente al supermercado', 2, 4, 4), -- Direcci�n 4
(2, 'Avenida Oeste 654', NULL, 98765, 2, 23456, 1, 'Edificio Rojo, Piso 12', 1, 5, 5), -- Direcci�n 5
(3, 'Calle Norte 987', 'Casa 20', 23456, 3, 76543, 0, 'Al lado del parque', 2, 6, 6), -- Direcci�n 6
(1, 'Avenida Principal 111', 'Apartamento 6C', 87654, 1, 34567, 1, 'Frente al cine', 1, 7, 7), -- Direcci�n 7
(2, 'Calle Secundaria 222', NULL, 23456, 2, 45678, 0, 'Edificio Amarillo, Piso 5', 2, 8, 8), -- Direcci�n 8
(3, 'Avenida Trasera 333', 'Casa 30', 76543, 3, 56789, 1, 'Detr�s del mercado', 1, 9, 9), -- Direcci�n 9
(1, 'Calle Escondida 444', 'Apartamento 7D', 34567, 1, 67890, 0, 'Frente a la escuela', 2, 10, 10); -- Direcci�n 10
...
('S�', 1, 1), -- �Posee veh�culos? - Persona 1
('No', 1, 2), -- �Posee propiedades? - Persona 1

('S�', 2, 1), -- �Posee veh�culos? - Persona 2
('S�', 2, 2), -- �Posee propiedades? - Persona 2

('No', 3, 1), -- �Posee veh�culos? - Persona 3
('S�', 3, 2), -- �Posee propiedades? - Persona 3

('S�', 4, 1), -- �Posee veh�culos? - Persona 4
('No', 4, 2), -- �Posee propiedades? - Persona 4

('No', 5, 1), -- �Posee veh�culos? - Persona 5
('No', 5, 2), -- �Posee propiedades? - Persona 5

('S�', 6, 1), -- �Posee veh�culos? - Persona 6
('S�', 6, 2), -- �Posee propiedades? - Persona 6

('No', 7, 1), -- �Posee veh�culos? - Persona 7
('S�', 7, 2), -- �Posee propiedades? - Persona 7

('S�', 8, 1), -- �Posee veh�culos? - Persona 8
('No', 8, 2), -- �Posee propiedades? - Persona 8

('No', 9, 1), -- �Posee veh�culos? - Persona 9
('S�', 9, 2), -- �Posee propiedades? - Persona 9

('S�', 10, 1), -- �Posee veh�culos? - Persona 10
('S�', 10, 2); -- �Posee propiedades? - Persona 10
